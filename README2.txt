This is an article about the tomcat-java-gateway installation process.
I suggest you IGNORE this article if you are not familiar with Chinese.
...
官方的书写说明对于"-"没有做说明,但是做实验发现jmx["Catalina:type=ThreadPool,name=\"http-bio-8080\"",maxThreads]能返回数据,jmx["Catalina:type=ThreadPool,name=http-bio-8080,maxThreads]不返回数据.需要特别注意.
